...
@Table(name = "transaction_events", indexes = {
        @Index(name = "idx_txn_events_txn_id", columnList = "transactionId"),
        @Index(name = "idx_txn_events_customer_id", columnList = "customerId")
})
@Data
@Builder
@AllArgsConstructor
...
public class TransactionEventEntity {
    ...
    public static TransactionEventEntity fromScored(ScoredTransaction scored) {
